...
We use [selenium](https://pypi.org/project/selenium/) to simulate the user session on the browser.
[BeautifulSoup](https://www.crummy.com/software/BeautifulSoup/bs4/doc/) is used to parse the html content from the page source, and
